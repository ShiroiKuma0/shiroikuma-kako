...
object FeatureFlags {
     ...
     * */
    // Fork: enabled on every channel — installing extensions from a custom AMO
    // collection on the release channel is the reason this fork exists.
    const val customExtensionCollectionFeature = true
