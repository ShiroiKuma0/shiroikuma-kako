...
/**
 * Who is allowed through the automation data door ([KakoAutomationProvider]), and how that is
 * decided. Copied verbatim from 自由作業盤's `core/automation/AutomationCallers.kt` — it is
 * deliberately app-independent, and the pins are the family's, not this fork's.
 *
 * ## Why not a token
 *
